...
The student homepage of empoweru.
...
class Homepage(tk.Frame):
    def __init__(self,master,student):
        ...
        self.shutdown_button = tk.Button(self.mainframe,text="SHUT DOWN and LOG OUT",font = "Impact 20", bg="dodgerblue",command= self.master.destroy,fg = "azure")
        self.shutdown_button.grid(row=3,column=0,padx=2)
    ...
    def open_python(self):
        """
        Opens python lesson access page.
    ...
    def open_infosec(self):
        """
        Opens information security lesson access page.

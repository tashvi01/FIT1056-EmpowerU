...
class PythonDataTypeQuizPage(tk.Frame):
    ...
    def __init__(self, master):
        ...
        # Example questions
        self.create_question(self.inner_frame, 1, "1. What is the data type of the variable “x” in the code x = 2?", ["integer", "string", "float"], "integer")
        self.create_question(self.inner_frame, 2, "2. How would you convert this string to an integer?", ["int()", "integer()", "str2int()"], "int()")
        self.create_question(self.inner_frame, 3, "3. What is the data type of the word 'hello' in Python?", ["str", "int", "float"], "str")
        self.create_question(self.inner_frame, 4, "4. What is the data type of the number 7 in Python?", ["float", "int", "str"], "int")
        self.create_question(self.inner_frame, 5, "5. What is the data type of the literal 'Hello, World!'?", ["str", "int", "float"], "str")

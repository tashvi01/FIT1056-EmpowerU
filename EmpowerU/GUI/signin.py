...
class SignIn(tk.Frame):
    ...
    def admin_login(self):
        ...
        switch_frame(self, lambda master: AdminLogin(self.master))
    ...
    def sign_in(self):
        ...
        Return(s): 
        instance of student logged in
        """
        self.username = self.username_var.get()
        self.password = self.password_var.get()
        print(self.authenticate(self.username, self.password))
